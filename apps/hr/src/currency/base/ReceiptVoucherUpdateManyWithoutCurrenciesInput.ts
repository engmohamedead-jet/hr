...
@InputType()
class ReceiptVoucherUpdateManyWithoutCurrenciesInput {
...
export { ReceiptVoucherUpdateManyWithoutCurrenciesInput as ReceiptVoucherUpdateManyWithoutCurrenciesInput };
