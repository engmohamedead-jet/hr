...
@InputType()
class PurchaseReturnUpdateManyWithoutCashRepositoriesInput {
...
export { PurchaseReturnUpdateManyWithoutCashRepositoriesInput as PurchaseReturnUpdateManyWithoutCashRepositoriesInput };
