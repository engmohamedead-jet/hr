...
@InputType()
class PaymentTermCreateNestedManyWithoutPeriodsInput {
...
export { PaymentTermCreateNestedManyWithoutPeriodsInput as PaymentTermCreateNestedManyWithoutPeriodsInput };
