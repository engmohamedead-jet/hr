...
@InputType()
class SaleQuotationDetailUpdateManyWithoutTenantsInput {
...
export { SaleQuotationDetailUpdateManyWithoutTenantsInput as SaleQuotationDetailUpdateManyWithoutTenantsInput };
