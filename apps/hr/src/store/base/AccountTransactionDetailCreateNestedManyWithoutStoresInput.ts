...
@InputType()
class AccountTransactionDetailCreateNestedManyWithoutStoresInput {
...
export { AccountTransactionDetailCreateNestedManyWithoutStoresInput as AccountTransactionDetailCreateNestedManyWithoutStoresInput };
