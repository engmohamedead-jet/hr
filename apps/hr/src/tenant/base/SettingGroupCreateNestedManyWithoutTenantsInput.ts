...
@InputType()
class SettingGroupCreateNestedManyWithoutTenantsInput {
...
export { SettingGroupCreateNestedManyWithoutTenantsInput as SettingGroupCreateNestedManyWithoutTenantsInput };
