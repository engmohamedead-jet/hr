...
@InputType()
class FailureReportingCreateNestedManyWithoutElevatorsInput {
...
export { FailureReportingCreateNestedManyWithoutElevatorsInput as FailureReportingCreateNestedManyWithoutElevatorsInput };
