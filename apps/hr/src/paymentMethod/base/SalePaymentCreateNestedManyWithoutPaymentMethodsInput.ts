...
@InputType()
class SalePaymentCreateNestedManyWithoutPaymentMethodsInput {
...
export { SalePaymentCreateNestedManyWithoutPaymentMethodsInput as SalePaymentCreateNestedManyWithoutPaymentMethodsInput };
