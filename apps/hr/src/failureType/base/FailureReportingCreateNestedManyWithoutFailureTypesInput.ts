...
@InputType()
class FailureReportingCreateNestedManyWithoutFailureTypesInput {
...
export { FailureReportingCreateNestedManyWithoutFailureTypesInput as FailureReportingCreateNestedManyWithoutFailureTypesInput };
