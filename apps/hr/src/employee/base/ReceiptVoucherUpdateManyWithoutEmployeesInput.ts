...
@InputType()
class ReceiptVoucherUpdateManyWithoutEmployeesInput {
...
export { ReceiptVoucherUpdateManyWithoutEmployeesInput as ReceiptVoucherUpdateManyWithoutEmployeesInput };
