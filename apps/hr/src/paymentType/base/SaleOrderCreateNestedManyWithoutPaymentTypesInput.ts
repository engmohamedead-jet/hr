...
@InputType()
class SaleOrderCreateNestedManyWithoutPaymentTypesInput {
...
export { SaleOrderCreateNestedManyWithoutPaymentTypesInput as SaleOrderCreateNestedManyWithoutPaymentTypesInput };
