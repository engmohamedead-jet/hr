...
@InputType()
class SaleDetailCreateNestedManyWithoutProductVariantsInput {
...
export { SaleDetailCreateNestedManyWithoutProductVariantsInput as SaleDetailCreateNestedManyWithoutProductVariantsInput };
