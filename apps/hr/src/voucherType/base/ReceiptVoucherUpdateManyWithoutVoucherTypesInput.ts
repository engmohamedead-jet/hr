...
@InputType()
class ReceiptVoucherUpdateManyWithoutVoucherTypesInput {
...
export { ReceiptVoucherUpdateManyWithoutVoucherTypesInput as ReceiptVoucherUpdateManyWithoutVoucherTypesInput };
