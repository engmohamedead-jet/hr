...
@InputType()
class PaymentVoucherCreateNestedManyWithoutExpenseItemsInput {
...
export { PaymentVoucherCreateNestedManyWithoutExpenseItemsInput as PaymentVoucherCreateNestedManyWithoutExpenseItemsInput };
