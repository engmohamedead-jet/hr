...
@InputType()
class FailureReportingCreateNestedManyWithoutCustomerUsersInput {
...
export { FailureReportingCreateNestedManyWithoutCustomerUsersInput as FailureReportingCreateNestedManyWithoutCustomerUsersInput };
