...
@InputType()
class PaymentVoucherCreateNestedManyWithoutCurrenciesInput {
...
export { PaymentVoucherCreateNestedManyWithoutCurrenciesInput as PaymentVoucherCreateNestedManyWithoutCurrenciesInput };
