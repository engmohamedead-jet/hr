...
@InputType()
class SalePaymentCreateNestedManyWithoutTenantsInput {
...
export { SalePaymentCreateNestedManyWithoutTenantsInput as SalePaymentCreateNestedManyWithoutTenantsInput };
