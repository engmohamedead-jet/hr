...
@InputType()
class ReceiptVoucherCreateNestedManyWithoutCustomersInput {
...
export { ReceiptVoucherCreateNestedManyWithoutCustomersInput as ReceiptVoucherCreateNestedManyWithoutCustomersInput };
