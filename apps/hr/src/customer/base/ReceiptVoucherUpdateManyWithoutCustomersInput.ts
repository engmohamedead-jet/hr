...
@InputType()
class ReceiptVoucherUpdateManyWithoutCustomersInput {
...
export { ReceiptVoucherUpdateManyWithoutCustomersInput as ReceiptVoucherUpdateManyWithoutCustomersInput };
