...
@InputType()
class PaymentVoucherUpdateManyWithoutCashRepositoriesInput {
...
export { PaymentVoucherUpdateManyWithoutCashRepositoriesInput as PaymentVoucherUpdateManyWithoutCashRepositoriesInput };
