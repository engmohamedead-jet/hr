...
@InputType()
class PurchaseReturnCreateNestedManyWithoutSuppliersInput {
...
export { PurchaseReturnCreateNestedManyWithoutSuppliersInput as PurchaseReturnCreateNestedManyWithoutSuppliersInput };
