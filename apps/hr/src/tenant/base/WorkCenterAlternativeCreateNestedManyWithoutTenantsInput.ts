...
@InputType()
class WorkCenterAlternativeCreateNestedManyWithoutTenantsInput {
...
export { WorkCenterAlternativeCreateNestedManyWithoutTenantsInput as WorkCenterAlternativeCreateNestedManyWithoutTenantsInput };
