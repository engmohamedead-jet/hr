...
@InputType()
class PrintTemplateCreateNestedManyWithoutTenantsInput {
...
export { PrintTemplateCreateNestedManyWithoutTenantsInput as PrintTemplateCreateNestedManyWithoutTenantsInput };
