...
@InputType()
class FiscalMonthCreateNestedManyWithoutFiscalYearsInput {
...
export { FiscalMonthCreateNestedManyWithoutFiscalYearsInput as FiscalMonthCreateNestedManyWithoutFiscalYearsInput };
