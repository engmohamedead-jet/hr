...
@InputType()
class PaymentVoucherUpdateManyWithoutSuppliersInput {
...
export { PaymentVoucherUpdateManyWithoutSuppliersInput as PaymentVoucherUpdateManyWithoutSuppliersInput };
