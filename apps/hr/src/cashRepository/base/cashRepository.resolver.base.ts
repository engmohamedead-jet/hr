...
export class CashRepositoryResolverBase {
  ...
  async createCashRepository(
    ...
    return await this.service.createCashRepository({
      ...
      data: {
        ...
        cashRepositories: args.data.cashRepositories
          ? {
              connect: args.data.cashRepositories,
            }
          : undefined,
  ...
  async getCashRepositories(
    ...
    const result = await this.service.getCashRepositories(parent.id);
