...
export class RatingControllerBase {
  ...
  @common.UseInterceptors(AclFilterResponseInterceptor)
  @common.Get("/:id/guarantorRatingI")
  @ApiNestedQuery(CustomerFindManyArgs)
  @nestAccessControl.UseRoles({
    resource: "Customer",
    action: "read",
  ...
  async findGuarantorRatingI(
    ...
    const query = plainToClass(CustomerFindManyArgs, request.query);
    const results = await this.service.findGuarantorRatingI(params.id, {
      ...query,
      select: {
        address: true,
        code: true,
  ...
  @common.Post("/:id/guarantorRatingI")
  @nestAccessControl.UseRoles({
    resource: "Rating",
    action: "update",
    possession: "any",
  })
  async connectGuarantorRatingI(
    @common.Param() params: RatingWhereUniqueInput,
    @common.Body() body: CustomerWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Patch("/:id/guarantorRatingI")
  @nestAccessControl.UseRoles({
    resource: "Rating",
    action: "update",
    possession: "any",
  })
  async updateGuarantorRatingI(
    @common.Param() params: RatingWhereUniqueInput,
    @common.Body() body: CustomerWhereUniqueInput[]
  ): Promise<void> {
    const data = {
  ...
  @common.Delete("/:id/guarantorRatingI")
  @nestAccessControl.UseRoles({
    resource: "Rating",
    action: "update",
    possession: "any",
  })
  async disconnectGuarantorRatingI(
    @common.Param() params: RatingWhereUniqueInput,
    @common.Body() body: CustomerWhereUniqueInput[]
  ): Promise<void> {
    const data = {
