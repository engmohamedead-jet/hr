...
@InputType()
class PurchaseReturnCreateInput {
  @ApiProperty({
    required: true,
  ...
  @ApiProperty({
    required: false,
    type: () => PurchaseReturnDetailCreateNestedManyWithoutPurchaseReturnsInput,
  })
  @ValidateNested()
  @Type(() => PurchaseReturnDetailCreateNestedManyWithoutPurchaseReturnsInput)
  @IsOptional()
  @Field(
    () => PurchaseReturnDetailCreateNestedManyWithoutPurchaseReturnsInput,
    {
      nullable: true,
    }
  )
...
export { PurchaseReturnCreateInput as PurchaseReturnCreateInput };
