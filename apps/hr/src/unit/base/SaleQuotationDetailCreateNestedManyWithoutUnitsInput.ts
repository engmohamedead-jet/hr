...
@InputType()
class SaleQuotationDetailCreateNestedManyWithoutUnitsInput {
...
export { SaleQuotationDetailCreateNestedManyWithoutUnitsInput as SaleQuotationDetailCreateNestedManyWithoutUnitsInput };
