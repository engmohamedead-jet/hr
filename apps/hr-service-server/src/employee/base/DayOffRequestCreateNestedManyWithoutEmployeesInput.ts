...
@InputType()
class DayOffRequestCreateNestedManyWithoutEmployeesInput {
...
export { DayOffRequestCreateNestedManyWithoutEmployeesInput as DayOffRequestCreateNestedManyWithoutEmployeesInput };
