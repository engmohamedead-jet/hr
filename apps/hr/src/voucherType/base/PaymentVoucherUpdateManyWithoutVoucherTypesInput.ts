...
@InputType()
class PaymentVoucherUpdateManyWithoutVoucherTypesInput {
...
export { PaymentVoucherUpdateManyWithoutVoucherTypesInput as PaymentVoucherUpdateManyWithoutVoucherTypesInput };
