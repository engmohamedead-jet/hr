...
@InputType()
class PurchaseReturnUpdateManyWithoutPaymentTypesInput {
...
export { PurchaseReturnUpdateManyWithoutPaymentTypesInput as PurchaseReturnUpdateManyWithoutPaymentTypesInput };
