...
@InputType()
class LeaveRequestCreateNestedManyWithoutTenantsInput {
...
export { LeaveRequestCreateNestedManyWithoutTenantsInput as LeaveRequestCreateNestedManyWithoutTenantsInput };
