...
@InputType()
class SaleDetailCreateNestedManyWithoutProductsInput {
...
export { SaleDetailCreateNestedManyWithoutProductsInput as SaleDetailCreateNestedManyWithoutProductsInput };
