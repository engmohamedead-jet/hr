...
import { PURCHASERETURN_TITLE_FIELD } from "./PurchaseReturnTitle";
...
export const PurchaseReturnShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
        <ReferenceField
        ...
        <TextField label="PurchaseReturnTotal" source="purchaseReturnTotal" />
