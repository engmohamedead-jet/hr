...
@InputType()
class BillOfMaterialCreateNestedManyWithoutProductVariantsInput {
...
export { BillOfMaterialCreateNestedManyWithoutProductVariantsInput as BillOfMaterialCreateNestedManyWithoutProductVariantsInput };
