...
@InputType()
class MaintenanceContractCreateNestedManyWithoutStoresInput {
...
export { MaintenanceContractCreateNestedManyWithoutStoresInput as MaintenanceContractCreateNestedManyWithoutStoresInput };
