...
@InputType()
class PurchaseReturnUpdateManyWithoutSuppliersInput {
...
export { PurchaseReturnUpdateManyWithoutSuppliersInput as PurchaseReturnUpdateManyWithoutSuppliersInput };
