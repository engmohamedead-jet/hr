...
@InputType()
class BillOfMaterialCreateNestedManyWithoutTenantsInput {
...
export { BillOfMaterialCreateNestedManyWithoutTenantsInput as BillOfMaterialCreateNestedManyWithoutTenantsInput };
