...
@InputType()
class PeriodicMaintenanceOrderUpdateManyWithoutStoresInput {
...
export { PeriodicMaintenanceOrderUpdateManyWithoutStoresInput as PeriodicMaintenanceOrderUpdateManyWithoutStoresInput };
