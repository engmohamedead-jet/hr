...
@InputType()
class PaymentVoucherUpdateManyWithoutAccountTransactionsInput {
...
export { PaymentVoucherUpdateManyWithoutAccountTransactionsInput as PaymentVoucherUpdateManyWithoutAccountTransactionsInput };
