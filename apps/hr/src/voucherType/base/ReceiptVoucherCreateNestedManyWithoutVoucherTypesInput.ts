...
@InputType()
class ReceiptVoucherCreateNestedManyWithoutVoucherTypesInput {
...
export { ReceiptVoucherCreateNestedManyWithoutVoucherTypesInput as ReceiptVoucherCreateNestedManyWithoutVoucherTypesInput };
