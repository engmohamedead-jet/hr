...
@InputType()
class InvoiceTypeCreateNestedManyWithoutTenantsInput {
...
export { InvoiceTypeCreateNestedManyWithoutTenantsInput as InvoiceTypeCreateNestedManyWithoutTenantsInput };
