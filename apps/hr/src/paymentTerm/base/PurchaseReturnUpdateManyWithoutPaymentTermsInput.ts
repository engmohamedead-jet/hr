...
@InputType()
class PurchaseReturnUpdateManyWithoutPaymentTermsInput {
...
export { PurchaseReturnUpdateManyWithoutPaymentTermsInput as PurchaseReturnUpdateManyWithoutPaymentTermsInput };
