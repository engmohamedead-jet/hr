...
@InputType()
class BillOfMaterialDetailUpdateManyWithoutUnitsInput {
...
export { BillOfMaterialDetailUpdateManyWithoutUnitsInput as BillOfMaterialDetailUpdateManyWithoutUnitsInput };
