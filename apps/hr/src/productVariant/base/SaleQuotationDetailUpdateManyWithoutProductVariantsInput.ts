...
@InputType()
class SaleQuotationDetailUpdateManyWithoutProductVariantsInput {
...
export { SaleQuotationDetailUpdateManyWithoutProductVariantsInput as SaleQuotationDetailUpdateManyWithoutProductVariantsInput };
