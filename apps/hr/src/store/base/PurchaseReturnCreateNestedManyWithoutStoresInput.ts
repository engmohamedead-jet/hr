...
@InputType()
class PurchaseReturnCreateNestedManyWithoutStoresInput {
...
export { PurchaseReturnCreateNestedManyWithoutStoresInput as PurchaseReturnCreateNestedManyWithoutStoresInput };
