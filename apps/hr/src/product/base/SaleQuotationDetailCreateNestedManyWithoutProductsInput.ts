...
@InputType()
class SaleQuotationDetailCreateNestedManyWithoutProductsInput {
...
export { SaleQuotationDetailCreateNestedManyWithoutProductsInput as SaleQuotationDetailCreateNestedManyWithoutProductsInput };
