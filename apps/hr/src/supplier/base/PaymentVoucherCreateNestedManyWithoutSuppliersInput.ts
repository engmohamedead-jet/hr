...
@InputType()
class PaymentVoucherCreateNestedManyWithoutSuppliersInput {
...
export { PaymentVoucherCreateNestedManyWithoutSuppliersInput as PaymentVoucherCreateNestedManyWithoutSuppliersInput };
