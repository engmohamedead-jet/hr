...
@InputType()
class DailyMovementRequestUpdateManyWithoutUsersInput {
...
export { DailyMovementRequestUpdateManyWithoutUsersInput as DailyMovementRequestUpdateManyWithoutUsersInput };
