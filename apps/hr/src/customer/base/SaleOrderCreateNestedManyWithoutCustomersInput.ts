...
@InputType()
class SaleOrderCreateNestedManyWithoutCustomersInput {
...
export { SaleOrderCreateNestedManyWithoutCustomersInput as SaleOrderCreateNestedManyWithoutCustomersInput };
