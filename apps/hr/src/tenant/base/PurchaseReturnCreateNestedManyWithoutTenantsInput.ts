...
@InputType()
class PurchaseReturnCreateNestedManyWithoutTenantsInput {
...
export { PurchaseReturnCreateNestedManyWithoutTenantsInput as PurchaseReturnCreateNestedManyWithoutTenantsInput };
