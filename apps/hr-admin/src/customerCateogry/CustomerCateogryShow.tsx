...
import { CUSTOMERCATEOGRY_TITLE_FIELD } from "./CustomerCateogryTitle";
...
export const CustomerCateogryShow = (props: ShowProps): React.ReactElement => {
  return (
    <Show {...props}>
      <SimpleShowLayout>
