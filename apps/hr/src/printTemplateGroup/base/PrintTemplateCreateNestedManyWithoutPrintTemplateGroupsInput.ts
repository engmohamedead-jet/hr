...
@InputType()
class PrintTemplateCreateNestedManyWithoutPrintTemplateGroupsInput {
...
export { PrintTemplateCreateNestedManyWithoutPrintTemplateGroupsInput as PrintTemplateCreateNestedManyWithoutPrintTemplateGroupsInput };
