...
@InputType()
class SaleQuotationDetailCreateNestedManyWithoutProductVariantsInput {
...
export { SaleQuotationDetailCreateNestedManyWithoutProductVariantsInput as SaleQuotationDetailCreateNestedManyWithoutProductVariantsInput };
