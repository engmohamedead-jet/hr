...
@InputType()
class WorkCenterWorkCenterTagCreateNestedManyWithoutTenantsInput {
...
export { WorkCenterWorkCenterTagCreateNestedManyWithoutTenantsInput as WorkCenterWorkCenterTagCreateNestedManyWithoutTenantsInput };
