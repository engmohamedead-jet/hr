...
@InputType()
class PaymentVoucherUpdateManyWithoutCurrenciesInput {
...
export { PaymentVoucherUpdateManyWithoutCurrenciesInput as PaymentVoucherUpdateManyWithoutCurrenciesInput };
