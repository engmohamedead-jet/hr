...
@InputType()
class PaymentVoucherUpdateManyWithoutEmployeesInput {
...
export { PaymentVoucherUpdateManyWithoutEmployeesInput as PaymentVoucherUpdateManyWithoutEmployeesInput };
