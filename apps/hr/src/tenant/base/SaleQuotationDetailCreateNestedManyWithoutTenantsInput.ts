...
@InputType()
class SaleQuotationDetailCreateNestedManyWithoutTenantsInput {
...
export { SaleQuotationDetailCreateNestedManyWithoutTenantsInput as SaleQuotationDetailCreateNestedManyWithoutTenantsInput };
