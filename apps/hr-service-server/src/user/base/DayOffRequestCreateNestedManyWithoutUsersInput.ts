...
@InputType()
class DayOffRequestCreateNestedManyWithoutUsersInput {
...
export { DayOffRequestCreateNestedManyWithoutUsersInput as DayOffRequestCreateNestedManyWithoutUsersInput };
