...
@InputType()
class CustomerUserCreateNestedManyWithoutElevatorsInput {
...
export { CustomerUserCreateNestedManyWithoutElevatorsInput as CustomerUserCreateNestedManyWithoutElevatorsInput };
