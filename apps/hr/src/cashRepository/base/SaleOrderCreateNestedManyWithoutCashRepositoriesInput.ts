...
@InputType()
class SaleOrderCreateNestedManyWithoutCashRepositoriesInput {
...
export { SaleOrderCreateNestedManyWithoutCashRepositoriesInput as SaleOrderCreateNestedManyWithoutCashRepositoriesInput };
