...
@InputType()
class ElevatorCreateNestedManyWithoutMotorTypesInput {
...
export { ElevatorCreateNestedManyWithoutMotorTypesInput as ElevatorCreateNestedManyWithoutMotorTypesInput };
