...
@InputType()
class PaymentVoucherCreateNestedManyWithoutCashRepositoriesInput {
...
export { PaymentVoucherCreateNestedManyWithoutCashRepositoriesInput as PaymentVoucherCreateNestedManyWithoutCashRepositoriesInput };
