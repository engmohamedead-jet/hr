...
@ArgsType()
class UpdateWorkCenterAlternativeArgs {
  @ApiProperty({
    required: true,
  ...
  @ApiProperty({
    required: true,
    type: () => WorkCenterAlternativeUpdateInput,
  })
  @ValidateNested()
  @Type(() => WorkCenterAlternativeUpdateInput)
  @Field(() => WorkCenterAlternativeUpdateInput, { nullable: false })
  data!: WorkCenterAlternativeUpdateInput;
}

export { UpdateWorkCenterAlternativeArgs as UpdateWorkCenterAlternativeArgs };
