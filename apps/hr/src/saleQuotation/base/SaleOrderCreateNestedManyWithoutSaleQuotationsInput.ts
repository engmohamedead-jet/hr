...
@InputType()
class SaleOrderCreateNestedManyWithoutSaleQuotationsInput {
...
export { SaleOrderCreateNestedManyWithoutSaleQuotationsInput as SaleOrderCreateNestedManyWithoutSaleQuotationsInput };
