...
@InputType()
class AccountTransactionDetailUpdateManyWithoutStoresInput {
...
export { AccountTransactionDetailUpdateManyWithoutStoresInput as AccountTransactionDetailUpdateManyWithoutStoresInput };
