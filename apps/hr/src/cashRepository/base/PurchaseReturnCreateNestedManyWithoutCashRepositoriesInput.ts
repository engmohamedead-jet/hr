...
@InputType()
class PurchaseReturnCreateNestedManyWithoutCashRepositoriesInput {
...
export { PurchaseReturnCreateNestedManyWithoutCashRepositoriesInput as PurchaseReturnCreateNestedManyWithoutCashRepositoriesInput };
