...
@InputType()
class FailureReportingUpdateManyWithoutCustomerUsersInput {
...
export { FailureReportingUpdateManyWithoutCustomerUsersInput as FailureReportingUpdateManyWithoutCustomerUsersInput };
