...
@InputType()
class BillOfMaterialCreateNestedManyWithoutUnitsInput {
...
export { BillOfMaterialCreateNestedManyWithoutUnitsInput as BillOfMaterialCreateNestedManyWithoutUnitsInput };
