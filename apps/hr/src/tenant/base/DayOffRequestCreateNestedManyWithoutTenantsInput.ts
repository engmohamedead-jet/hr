...
@InputType()
class DayOffRequestCreateNestedManyWithoutTenantsInput {
...
export { DayOffRequestCreateNestedManyWithoutTenantsInput as DayOffRequestCreateNestedManyWithoutTenantsInput };
