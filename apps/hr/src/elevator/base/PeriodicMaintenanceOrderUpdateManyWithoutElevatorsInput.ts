...
@InputType()
class PeriodicMaintenanceOrderUpdateManyWithoutElevatorsInput {
...
export { PeriodicMaintenanceOrderUpdateManyWithoutElevatorsInput as PeriodicMaintenanceOrderUpdateManyWithoutElevatorsInput };
