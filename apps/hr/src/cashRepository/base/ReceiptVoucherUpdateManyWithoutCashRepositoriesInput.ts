...
@InputType()
class ReceiptVoucherUpdateManyWithoutCashRepositoriesInput {
...
export { ReceiptVoucherUpdateManyWithoutCashRepositoriesInput as ReceiptVoucherUpdateManyWithoutCashRepositoriesInput };
