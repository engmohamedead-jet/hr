...
@InputType()
class PaymentVoucherCreateNestedManyWithoutEmployeesInput {
...
export { PaymentVoucherCreateNestedManyWithoutEmployeesInput as PaymentVoucherCreateNestedManyWithoutEmployeesInput };
