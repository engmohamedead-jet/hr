...
@InputType()
class SaleReturnCreateNestedManyWithoutTenantsInput {
...
export { SaleReturnCreateNestedManyWithoutTenantsInput as SaleReturnCreateNestedManyWithoutTenantsInput };
