...
@InputType()
class PaymentTermCreateNestedManyWithoutTenantsInput {
...
export { PaymentTermCreateNestedManyWithoutTenantsInput as PaymentTermCreateNestedManyWithoutTenantsInput };
