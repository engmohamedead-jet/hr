...
@InputType()
class SaleDetailUpdateManyWithoutProductVariantsInput {
...
export { SaleDetailUpdateManyWithoutProductVariantsInput as SaleDetailUpdateManyWithoutProductVariantsInput };
