...
@InputType()
class ProductVariantUpdateManyWithoutAttributeValuesInput {
...
export { ProductVariantUpdateManyWithoutAttributeValuesInput as ProductVariantUpdateManyWithoutAttributeValuesInput };
