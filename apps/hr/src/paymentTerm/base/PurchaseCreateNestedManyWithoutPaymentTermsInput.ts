...
@InputType()
class PurchaseCreateNestedManyWithoutPaymentTermsInput {
...
export { PurchaseCreateNestedManyWithoutPaymentTermsInput as PurchaseCreateNestedManyWithoutPaymentTermsInput };
