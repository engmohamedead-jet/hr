...
@InputType()
class LeaveRequestCreateNestedManyWithoutUsersInput {
...
export { LeaveRequestCreateNestedManyWithoutUsersInput as LeaveRequestCreateNestedManyWithoutUsersInput };
