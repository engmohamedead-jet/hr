...
@InputType()
class SalePaymentCreateNestedManyWithoutBankBranchesInput {
...
export { SalePaymentCreateNestedManyWithoutBankBranchesInput as SalePaymentCreateNestedManyWithoutBankBranchesInput };
