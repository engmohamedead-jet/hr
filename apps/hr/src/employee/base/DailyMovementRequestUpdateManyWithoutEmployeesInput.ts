...
@InputType()
class DailyMovementRequestUpdateManyWithoutEmployeesInput {
...
export { DailyMovementRequestUpdateManyWithoutEmployeesInput as DailyMovementRequestUpdateManyWithoutEmployeesInput };
