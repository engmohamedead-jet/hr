...
@InputType()
class MaintenanceContractCreateNestedManyWithoutContractPeriodsInput {
...
export { MaintenanceContractCreateNestedManyWithoutContractPeriodsInput as MaintenanceContractCreateNestedManyWithoutContractPeriodsInput };
