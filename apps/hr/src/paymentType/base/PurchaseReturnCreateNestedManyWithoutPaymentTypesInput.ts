...
@InputType()
class PurchaseReturnCreateNestedManyWithoutPaymentTypesInput {
...
export { PurchaseReturnCreateNestedManyWithoutPaymentTypesInput as PurchaseReturnCreateNestedManyWithoutPaymentTypesInput };
