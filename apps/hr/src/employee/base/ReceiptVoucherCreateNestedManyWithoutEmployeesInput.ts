...
@InputType()
class ReceiptVoucherCreateNestedManyWithoutEmployeesInput {
...
export { ReceiptVoucherCreateNestedManyWithoutEmployeesInput as ReceiptVoucherCreateNestedManyWithoutEmployeesInput };
