...
@InputType()
class ElevatorCreateNestedManyWithoutControlTypesInput {
...
export { ElevatorCreateNestedManyWithoutControlTypesInput as ElevatorCreateNestedManyWithoutControlTypesInput };
