...
@InputType()
class WorkCenterProductivityLossTypeUpdateInput {
  @ApiProperty({
    required: false,
    type: String,
  })
  ...
  @ApiProperty({
    required: false,
    type: () =>
      WorkCenterProductivityLossUpdateManyWithoutWorkCenterProductivityLossTypesInput,
  })
  @ValidateNested()
  @Type(
    () =>
...
export { WorkCenterProductivityLossTypeUpdateInput as WorkCenterProductivityLossTypeUpdateInput };
