...
@InputType()
class ElevatorCreateNestedManyWithoutElevatorTypesInput {
...
export { ElevatorCreateNestedManyWithoutElevatorTypesInput as ElevatorCreateNestedManyWithoutElevatorTypesInput };
