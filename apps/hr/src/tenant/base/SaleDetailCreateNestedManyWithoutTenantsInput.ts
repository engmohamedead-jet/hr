...
@InputType()
class SaleDetailCreateNestedManyWithoutTenantsInput {
...
export { SaleDetailCreateNestedManyWithoutTenantsInput as SaleDetailCreateNestedManyWithoutTenantsInput };
