...
@InputType()
class ProductUnitCreateNestedManyWithoutProductsInput {
...
export { ProductUnitCreateNestedManyWithoutProductsInput as ProductUnitCreateNestedManyWithoutProductsInput };
