...
@InputType()
class InstallationContractCreateNestedManyWithoutElevatorsInput {
...
export { InstallationContractCreateNestedManyWithoutElevatorsInput as InstallationContractCreateNestedManyWithoutElevatorsInput };
