...
@InputType()
class AccountTransactionDetailCreateNestedManyWithoutTransactionTypesInput {
...
export { AccountTransactionDetailCreateNestedManyWithoutTransactionTypesInput as AccountTransactionDetailCreateNestedManyWithoutTransactionTypesInput };
