...
@InputType()
class FailureReportingCreateNestedManyWithoutStoresInput {
...
export { FailureReportingCreateNestedManyWithoutStoresInput as FailureReportingCreateNestedManyWithoutStoresInput };
