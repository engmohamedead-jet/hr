...
export class CustomerCateogryControllerBase {
  constructor(
  ...
  @common.Post()
  @swagger.ApiCreatedResponse({ type: CustomerCateogry })
  ...
  async createCustomerCateogry(
    @common.Body() data: CustomerCateogryCreateInput
  ...
  @common.Get()
  @swagger.ApiOkResponse({ type: [CustomerCateogry] })
  @ApiNestedQuery(CustomerCateogryFindManyArgs)
  @nestAccessControl.UseRoles({
    resource: "CustomerCateogry",
    action: "read",
    possession: "any",
  ...
  async customerCateogries(
    ...
    const args = plainToClass(CustomerCateogryFindManyArgs, request.query);
    return this.service.customerCateogries({
      ...args,
      select: {
        code: true,
        createdAt: true,
  ...
  async customerCateogry(
    @common.Param() params: CustomerCateogryWhereUniqueInput
  ): Promise<CustomerCateogry | null> {
    const result = await this.service.customerCateogry({
      where: params,
      select: {
        code: true,
        createdAt: true,
  ...
  async updateCustomerCateogry(
    @common.Param() params: CustomerCateogryWhereUniqueInput,
    @common.Body() data: CustomerCateogryUpdateInput
  ): Promise<CustomerCateogry | null> {
    try {
  ...
  async deleteCustomerCateogry(
    ...
    try {
      return await this.service.deleteCustomerCateogry({
        where: params,
        select: {
          code: true,
          createdAt: true,
  ...
  async connectCustomers(
    ...
    await this.service.updateCustomerCateogry({
      where: params,
      data,
      select: { id: true },
    });
