...
@InputType()
class SaleOrderUpdateManyWithoutSaleQuotationsInput {
...
export { SaleOrderUpdateManyWithoutSaleQuotationsInput as SaleOrderUpdateManyWithoutSaleQuotationsInput };
