...
@InputType()
class ProductVariantCreateNestedManyWithoutAttributeValuesInput {
...
export { ProductVariantCreateNestedManyWithoutAttributeValuesInput as ProductVariantCreateNestedManyWithoutAttributeValuesInput };
