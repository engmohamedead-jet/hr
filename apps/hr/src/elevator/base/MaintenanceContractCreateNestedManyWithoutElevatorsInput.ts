...
@InputType()
class MaintenanceContractCreateNestedManyWithoutElevatorsInput {
...
export { MaintenanceContractCreateNestedManyWithoutElevatorsInput as MaintenanceContractCreateNestedManyWithoutElevatorsInput };
