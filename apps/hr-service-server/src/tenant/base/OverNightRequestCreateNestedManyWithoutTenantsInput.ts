...
@InputType()
class OverNightRequestCreateNestedManyWithoutTenantsInput {
...
export { OverNightRequestCreateNestedManyWithoutTenantsInput as OverNightRequestCreateNestedManyWithoutTenantsInput };
