...
@InputType()
class SaleReturnCreateNestedManyWithoutCashRepositoriesInput {
...
export { SaleReturnCreateNestedManyWithoutCashRepositoriesInput as SaleReturnCreateNestedManyWithoutCashRepositoriesInput };
