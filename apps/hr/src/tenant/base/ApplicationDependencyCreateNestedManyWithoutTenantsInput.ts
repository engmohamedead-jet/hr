...
@InputType()
class ApplicationDependencyCreateNestedManyWithoutTenantsInput {
...
export { ApplicationDependencyCreateNestedManyWithoutTenantsInput as ApplicationDependencyCreateNestedManyWithoutTenantsInput };
