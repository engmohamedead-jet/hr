...
@InputType()
class ShippingStatusCreateNestedManyWithoutTenantsInput {
...
export { ShippingStatusCreateNestedManyWithoutTenantsInput as ShippingStatusCreateNestedManyWithoutTenantsInput };
