...
@InputType()
class SalaryItemTypeCreateNestedManyWithoutTenantsInput {
...
export { SalaryItemTypeCreateNestedManyWithoutTenantsInput as SalaryItemTypeCreateNestedManyWithoutTenantsInput };
