...
@InputType()
class WorkCenterCreateNestedManyWithoutTenantsInput {
...
export { WorkCenterCreateNestedManyWithoutTenantsInput as WorkCenterCreateNestedManyWithoutTenantsInput };
