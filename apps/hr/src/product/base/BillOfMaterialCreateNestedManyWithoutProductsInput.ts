...
@InputType()
class BillOfMaterialCreateNestedManyWithoutProductsInput {
...
export { BillOfMaterialCreateNestedManyWithoutProductsInput as BillOfMaterialCreateNestedManyWithoutProductsInput };
