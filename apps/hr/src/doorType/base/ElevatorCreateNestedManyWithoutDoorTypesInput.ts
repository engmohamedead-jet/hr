...
@InputType()
class ElevatorCreateNestedManyWithoutDoorTypesInput {
...
export { ElevatorCreateNestedManyWithoutDoorTypesInput as ElevatorCreateNestedManyWithoutDoorTypesInput };
