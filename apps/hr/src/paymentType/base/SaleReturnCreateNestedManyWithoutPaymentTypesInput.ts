...
@InputType()
class SaleReturnCreateNestedManyWithoutPaymentTypesInput {
...
export { SaleReturnCreateNestedManyWithoutPaymentTypesInput as SaleReturnCreateNestedManyWithoutPaymentTypesInput };
