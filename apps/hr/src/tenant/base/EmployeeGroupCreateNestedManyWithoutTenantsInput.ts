...
@InputType()
class EmployeeGroupCreateNestedManyWithoutTenantsInput {
...
export { EmployeeGroupCreateNestedManyWithoutTenantsInput as EmployeeGroupCreateNestedManyWithoutTenantsInput };
