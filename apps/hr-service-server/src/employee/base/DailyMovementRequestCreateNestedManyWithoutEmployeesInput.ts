...
@InputType()
class DailyMovementRequestCreateNestedManyWithoutEmployeesInput {
...
export { DailyMovementRequestCreateNestedManyWithoutEmployeesInput as DailyMovementRequestCreateNestedManyWithoutEmployeesInput };
