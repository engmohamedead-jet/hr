...
@InputType()
class AccountTransactionCreateNestedManyWithoutStoresInput {
...
export { AccountTransactionCreateNestedManyWithoutStoresInput as AccountTransactionCreateNestedManyWithoutStoresInput };
