...
@InputType()
class SaleReturnCreateNestedManyWithoutCustomersInput {
...
export { SaleReturnCreateNestedManyWithoutCustomersInput as SaleReturnCreateNestedManyWithoutCustomersInput };
