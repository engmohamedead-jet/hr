...
@InputType()
class BillOfMaterialCreateNestedManyWithoutBillOfMaterialTypesInput {
...
export { BillOfMaterialCreateNestedManyWithoutBillOfMaterialTypesInput as BillOfMaterialCreateNestedManyWithoutBillOfMaterialTypesInput };
