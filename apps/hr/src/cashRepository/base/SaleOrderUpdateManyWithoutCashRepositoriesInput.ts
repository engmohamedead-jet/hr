...
@InputType()
class SaleOrderUpdateManyWithoutCashRepositoriesInput {
...
export { SaleOrderUpdateManyWithoutCashRepositoriesInput as SaleOrderUpdateManyWithoutCashRepositoriesInput };
