...
@InputType()
class BankAccountCreateNestedManyWithoutBankBranchesInput {
...
export { BankAccountCreateNestedManyWithoutBankBranchesInput as BankAccountCreateNestedManyWithoutBankBranchesInput };
