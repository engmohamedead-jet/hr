...
@InputType()
class SaleQuotationDetailUpdateManyWithoutProductsInput {
...
export { SaleQuotationDetailUpdateManyWithoutProductsInput as SaleQuotationDetailUpdateManyWithoutProductsInput };
