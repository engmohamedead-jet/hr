...
@InputType()
class PurchaseCreateNestedManyWithoutInvoiceTypesInput {
...
export { PurchaseCreateNestedManyWithoutInvoiceTypesInput as PurchaseCreateNestedManyWithoutInvoiceTypesInput };
