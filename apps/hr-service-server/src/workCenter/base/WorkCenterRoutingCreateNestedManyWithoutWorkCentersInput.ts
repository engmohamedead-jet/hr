...
@InputType()
class WorkCenterRoutingCreateNestedManyWithoutWorkCentersInput {
...
export { WorkCenterRoutingCreateNestedManyWithoutWorkCentersInput as WorkCenterRoutingCreateNestedManyWithoutWorkCentersInput };
