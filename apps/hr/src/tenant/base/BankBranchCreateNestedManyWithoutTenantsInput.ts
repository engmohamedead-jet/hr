...
@InputType()
class BankBranchCreateNestedManyWithoutTenantsInput {
...
export { BankBranchCreateNestedManyWithoutTenantsInput as BankBranchCreateNestedManyWithoutTenantsInput };
