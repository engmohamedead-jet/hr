...
@InputType()
class ReceiptVoucherCreateNestedManyWithoutTenantsInput {
...
export { ReceiptVoucherCreateNestedManyWithoutTenantsInput as ReceiptVoucherCreateNestedManyWithoutTenantsInput };
