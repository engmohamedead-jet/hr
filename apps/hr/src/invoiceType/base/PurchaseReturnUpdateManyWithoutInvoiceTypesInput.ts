...
@InputType()
class PurchaseReturnUpdateManyWithoutInvoiceTypesInput {
...
export { PurchaseReturnUpdateManyWithoutInvoiceTypesInput as PurchaseReturnUpdateManyWithoutInvoiceTypesInput };
