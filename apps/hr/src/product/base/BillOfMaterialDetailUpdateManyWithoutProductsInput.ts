...
@InputType()
class BillOfMaterialDetailUpdateManyWithoutProductsInput {
...
export { BillOfMaterialDetailUpdateManyWithoutProductsInput as BillOfMaterialDetailUpdateManyWithoutProductsInput };
