...
@InputType()
class DailyMovementRequestCreateNestedManyWithoutUsersInput {
...
export { DailyMovementRequestCreateNestedManyWithoutUsersInput as DailyMovementRequestCreateNestedManyWithoutUsersInput };
