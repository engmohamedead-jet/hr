...
@InputType()
class CashRepositoryCreateNestedManyWithoutTenantsInput {
...
export { CashRepositoryCreateNestedManyWithoutTenantsInput as CashRepositoryCreateNestedManyWithoutTenantsInput };
