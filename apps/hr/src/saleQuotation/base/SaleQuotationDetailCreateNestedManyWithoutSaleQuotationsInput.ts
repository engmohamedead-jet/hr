...
@InputType()
class SaleQuotationDetailCreateNestedManyWithoutSaleQuotationsInput {
...
export { SaleQuotationDetailCreateNestedManyWithoutSaleQuotationsInput as SaleQuotationDetailCreateNestedManyWithoutSaleQuotationsInput };
