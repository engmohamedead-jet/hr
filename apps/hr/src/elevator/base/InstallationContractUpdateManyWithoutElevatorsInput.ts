...
@InputType()
class InstallationContractUpdateManyWithoutElevatorsInput {
...
export { InstallationContractUpdateManyWithoutElevatorsInput as InstallationContractUpdateManyWithoutElevatorsInput };
