...
@InputType()
class WorkCenterWorkCenterTagUpdateManyWithoutTenantsInput {
...
export { WorkCenterWorkCenterTagUpdateManyWithoutTenantsInput as WorkCenterWorkCenterTagUpdateManyWithoutTenantsInput };
