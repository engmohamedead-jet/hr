...
@InputType()
class FailureReportingCreateNestedManyWithoutCustomerElevatorsInput {
...
export { FailureReportingCreateNestedManyWithoutCustomerElevatorsInput as FailureReportingCreateNestedManyWithoutCustomerElevatorsInput };
