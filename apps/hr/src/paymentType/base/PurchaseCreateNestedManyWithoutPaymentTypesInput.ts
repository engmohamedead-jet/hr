...
@InputType()
class PurchaseCreateNestedManyWithoutPaymentTypesInput {
...
export { PurchaseCreateNestedManyWithoutPaymentTypesInput as PurchaseCreateNestedManyWithoutPaymentTypesInput };
