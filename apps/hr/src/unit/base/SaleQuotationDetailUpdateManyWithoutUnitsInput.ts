...
@InputType()
class SaleQuotationDetailUpdateManyWithoutUnitsInput {
...
export { SaleQuotationDetailUpdateManyWithoutUnitsInput as SaleQuotationDetailUpdateManyWithoutUnitsInput };
