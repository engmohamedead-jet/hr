...
@InputType()
class SaleOrderCreateNestedManyWithoutInvoiceTypesInput {
...
export { SaleOrderCreateNestedManyWithoutInvoiceTypesInput as SaleOrderCreateNestedManyWithoutInvoiceTypesInput };
