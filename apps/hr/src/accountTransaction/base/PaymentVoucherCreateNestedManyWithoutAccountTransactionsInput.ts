...
@InputType()
class PaymentVoucherCreateNestedManyWithoutAccountTransactionsInput {
...
export { PaymentVoucherCreateNestedManyWithoutAccountTransactionsInput as PaymentVoucherCreateNestedManyWithoutAccountTransactionsInput };
