...
@InputType()
class ReceiptVoucherCreateNestedManyWithoutCurrenciesInput {
...
export { ReceiptVoucherCreateNestedManyWithoutCurrenciesInput as ReceiptVoucherCreateNestedManyWithoutCurrenciesInput };
