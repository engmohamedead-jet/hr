...
@InputType()
class ProductCategoryCreateNestedManyWithoutProductDepartmentsInput {
...
export { ProductCategoryCreateNestedManyWithoutProductDepartmentsInput as ProductCategoryCreateNestedManyWithoutProductDepartmentsInput };
