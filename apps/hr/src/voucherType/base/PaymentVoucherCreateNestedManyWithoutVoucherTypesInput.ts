...
@InputType()
class PaymentVoucherCreateNestedManyWithoutVoucherTypesInput {
...
export { PaymentVoucherCreateNestedManyWithoutVoucherTypesInput as PaymentVoucherCreateNestedManyWithoutVoucherTypesInput };
