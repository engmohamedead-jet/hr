  ...
  async createApplication(
    ...
    return await this.service.createApplication({
      data: {
        ...
        DependsOnApplicationDependency: data.DependsOnApplicationDependency
          ? {
              connect: data.DependsOnApplicationDependency,
            }
          : undefined,

        applicationDependency: data.applicationDependency
          ? {
              connect: data.applicationDependency,
            }
          : undefined,
