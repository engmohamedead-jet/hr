...
class EmployeeRoleCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => EmployeeCreateNestedManyWithoutEmployeeRolesInput,
  })
  @ValidateNested()
  @Type(() => EmployeeCreateNestedManyWithoutEmployeeRolesInput)
  @IsOptional()
  @Field(() => EmployeeCreateNestedManyWithoutEmployeeRolesInput, {
    nullable: true,
  })
...
export { EmployeeRoleCreateInput as EmployeeRoleCreateInput };
