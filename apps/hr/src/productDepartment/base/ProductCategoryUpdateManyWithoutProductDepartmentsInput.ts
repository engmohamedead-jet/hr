...
@InputType()
class ProductCategoryUpdateManyWithoutProductDepartmentsInput {
...
export { ProductCategoryUpdateManyWithoutProductDepartmentsInput as ProductCategoryUpdateManyWithoutProductDepartmentsInput };
