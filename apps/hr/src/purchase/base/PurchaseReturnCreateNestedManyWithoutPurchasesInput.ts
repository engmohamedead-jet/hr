...
@InputType()
class PurchaseReturnCreateNestedManyWithoutPurchasesInput {
...
export { PurchaseReturnCreateNestedManyWithoutPurchasesInput as PurchaseReturnCreateNestedManyWithoutPurchasesInput };
