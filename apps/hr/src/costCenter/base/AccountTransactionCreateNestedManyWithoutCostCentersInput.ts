...
@InputType()
class AccountTransactionCreateNestedManyWithoutCostCentersInput {
...
export { AccountTransactionCreateNestedManyWithoutCostCentersInput as AccountTransactionCreateNestedManyWithoutCostCentersInput };
