...
@InputType()
class FailureReportingUpdateManyWithoutElevatorsInput {
...
export { FailureReportingUpdateManyWithoutElevatorsInput as FailureReportingUpdateManyWithoutElevatorsInput };
