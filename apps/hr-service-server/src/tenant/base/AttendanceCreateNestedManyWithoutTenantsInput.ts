...
@InputType()
class AttendanceCreateNestedManyWithoutTenantsInput {
...
export { AttendanceCreateNestedManyWithoutTenantsInput as AttendanceCreateNestedManyWithoutTenantsInput };
