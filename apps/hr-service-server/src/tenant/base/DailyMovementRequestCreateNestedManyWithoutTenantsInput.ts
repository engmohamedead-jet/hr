...
@InputType()
class DailyMovementRequestCreateNestedManyWithoutTenantsInput {
...
export { DailyMovementRequestCreateNestedManyWithoutTenantsInput as DailyMovementRequestCreateNestedManyWithoutTenantsInput };
